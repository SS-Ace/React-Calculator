    ...
    render(){
        return (
            <div className="buttons">
                ...
                <button name=")" onClick={this.buttonPressed}>)</button>
                <button name="C" onClick={this.buttonPressed} className="clear" id="highlight">C</button>
                ...
                <button name="CE" onClick={this.buttonPressed} id="highlight">CE</button>
                ...
                <button name="+" onClick={this.buttonPressed} id="highlight">+</button>
                ...
                <button name="." onClick={this.buttonPressed}>.</button>
                <button name="*" onClick={this.buttonPressed} id="highlight">*</button>
                <button name="=" onClick={this.buttonPressed} className="equal" id="highlight">=</button>
                <button name="/" onClick={this.buttonPressed} id="highlight">/</button>
